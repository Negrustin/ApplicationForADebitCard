...
public class ApplicationForADebitCardPage {
    ...
    public void getErrorMassageNameElement(String errorMassage) {
        Selenide.$x("//*[@data-test-id ='name' and contains(@class, 'input_invalid')]")
                .shouldHave(Condition.text(errorMassage)).
                shouldBe(Condition.visible);
    }


    public void getErrorMassagePhoneElement(String errorMassage) {
        Selenide.$x("//*[@data-test-id ='phone']|span[contains(@class, 'invalid')]")
                .shouldHave(Condition.text(errorMassage))
                .shouldBe(Condition.visible);
    }
